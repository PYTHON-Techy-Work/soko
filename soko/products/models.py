...
class Delivery(SurrogatePK, Model):
    ...
    quantity = Column(db.Integer, nullable=False)
    purchase_date = Column(db.DateTime.date, nullable=False)
    purchase_time = Column(db.DateTime.time, nullable=False)
...
class Order(SurrogatePK, Model):
    ...
    order_date = Column(db.DateTime.date, nullable=False)
    order_time = Column(db.DateTime.time, nullable=False)
